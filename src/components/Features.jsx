function Features() {
  return (
    <div className="w-full flex justify-center items-center flex-col bg-[#181818] font-sans text-white pt-[162px] px-[50px]">
      ...
      <section className="flex flex-row  flex-wrap justify-center mt-20 ">
        <div className="md:flex-none flex flex-col items-center md:items-start">
          <img
            src="/controlpanel-section1.png"
            alt="zdj"
            className=" w-2/3 h-auto"
          />
          <img
            className="relative md:left-64 bottom-20 md:bottom-24 w-2/4"
            src="/controlpanel-section1-2.png"
          />
        </div>
        <div className="flex flex-col justify-around items-center p-5 space-y-10">
          ...
          <div className="flex flex-col items-start">
            <div className="flex flex-row items-center space-x-5">
              ...
              <h3 className="text-left font-medium text-2xl">Or with rules</h3>
            </div>
            <p className="text-left">
              When you add work to your <br />
              Slate calendar we automatically <br />
